          ...
          <div className="space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                  <motion.button 
                    ...
                    className="flex flex-col items-center gap-1 p-2 bg-white hover:bg-stone-50 rounded-xl border border-stone-200 shadow-sm transition-all" 
                    title="Text"
                  >
                ...
                <div className="flex items-center gap-2 p-1 bg-stone-100 rounded-lg">
                  ...
                  <div className="flex items-center gap-1 bg-white rounded-md p-1 shadow-sm">
                    <motion.button whileTap={{ scale: 0.8 }} onClick={() => setZoom(Math.max(0.1, zoom - 0.1))} className="p-1 hover:bg-stone-100 rounded"><Minus className="w-3 h-3" /></motion.button>
                    <span className="text-[9px] font-bold w-8 text-center">{Math.round(zoom * 100)}%</span>
                    <motion.button whileTap={{ scale: 0.8 }} onClick={() => setZoom(Math.min(3, zoom + 0.1))} className="p-1 hover:bg-stone-100 rounded"><Plus className="w-3 h-3" /></motion.button>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-auto space-y-2">
          <div className="grid grid-cols-2 gap-2">
            ...
            <motion.label 
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="flex items-center justify-center gap-2 p-2 bg-stone-100 text-stone-600 rounded-xl hover:bg-stone-200 transition-all border border-stone-200 cursor-pointer"
            >
